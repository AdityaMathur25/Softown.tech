...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../user/my-purchases/" aria-expanded="false">
                                <i class="mdi mdi-clock-fast"></i>
                                <span class="hide-menu">Purchase History</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../user/wallet/" aria-expanded="false">
                                <i class="mdi mdi-wallet"></i>
                                <span class="hide-menu">My Wallet</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../user/add-funds/" aria-expanded="false">
      ...
      Please Udpdate Your <a href="./edit/" class="alert-link">Email</a>. To receive the notifications.
            ...
            <!-- ============================================================== -->
            <?php
            $sql = "SELECT * FROM `purchased_products` WHERE buyer_name='$un'  ";
            //$records = mysqli_query($con, $sql); // fetch data from database
            ...
            ?>
                <div class="container-fluid">
                    <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
                        <div class="card p-4">
                            <div class=" image d-flex flex-column justify-content-center align-items-center"> <button class="btn btn-secondary"> <img src="https://cdn-icons-png.flaticon.com/512/5556/5556468.png" height="100" width="100" /></button> <span class="name mt-3"><?php echo $un;  ?></span> <span class="idd"><?php echo 'Account Status : ' . $_SESSION["type"]; ?></span>
                                <span class="follow">Software Purchased : <span class="number"><?php echo $rowcount ?></span></span>
                                <div class="text mt-3">
                                    <?php
                                    $sql = "SELECT * FROM `users` WHERE username='" . $_SESSION['username'] . "'  ";
