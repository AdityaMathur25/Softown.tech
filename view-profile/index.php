...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../developer/view-product/" aria-expanded="false">
                                <i class="mdi mdi-tune"></i>
                                <span class="hide-menu">Manage Softwares </span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../developer/wallet/" aria-expanded="false">
                                <i class="mdi mdi-wallet"></i>
                                <span class="hide-menu">My Wallet</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../developer/add-funds/" aria-expanded="false">
                                <i class="mdi mdi-keyboard-backspace"></i>
                                <span class="hide-menu">Add funds</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../developer/withdraw-funds/" aria-expanded="false">
                                <i class="mdi mdi-keyboard-tab"></i>
                                <span class="hide-menu">Withdraw funds</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../developer/upgrade-plan/" aria-expanded="false">
        ...
        <div class="page-wrapper">
            ...
            $sql = "select * from `users` where username = '$un' AND email IS NULL LIMIT 1";
            $res = mysqli_query($con, $sql);
            if (mysqli_num_rows($res) > 0) {
                while ($mess = mysqli_fetch_array($res)) {
                    echo '
                            <div class="alert alert-danger" role="alert">
      Please Udpdate Your <a href="./edit/" class="alert-link">Email</a>. To receive the notifications.
    </div>';
                }
            }
            ...
            <!-- ============================================================== -->
            <?php
            $sql = "SELECT * FROM `products` WHERE developer='$un'  ";
            //$records = mysqli_query($con, $sql); // fetch data from database
            ...
            ?>
                <div class="container-fluid">
                    <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
                        <div class="card p-4">
                            <div class=" image d-flex flex-column justify-content-center align-items-center"> <button class="btn btn-secondary"> <img src="https://avatars.githubusercontent.com/u/41422704?v=4" height="100" width="100" /></button> <span class="name mt-3"><?php echo $un;  ?></span> <span class="idd"><?php echo 'Account Status : ' . $_SESSION["type"]; ?></span>
                                <span class="follow">Published Software : <span class="number"><?php echo $rowcount ?></span></span>
                                <div class="text mt-3">
                                    <?php
                                    $sql = "SELECT * FROM `users` WHERE username='" . $_SESSION['username'] . "'  ";
                                    ...
                                    ?>
                                        <span>Your Email :- <?php echo $data['email']?> </span>
                                    <?php
                                    } ?>
                                </div><br>
                                <div class=" d-flex mt-2"> <button class="btn1 btn-dark" onclick="window.location.href='./edit/';" >Edit Profile</button> </div>
                            </div> <?php }
                                    ?>
                        </div>
                    </div>
