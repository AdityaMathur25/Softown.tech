        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                if (isset($_POST["sub-btn"])) {
                    $name = $_POST['name'];
                    $em = $_POST['email'];
                    $sql = "UPDATE `users` SET `name` = '$name' , `email` = '$em' WHERE username='" . $_SESSION['username'] . "'  ";
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle">Enter Your Details to Update it in Profile section </h6>
                                    <form class="m-t-30" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control" id="email" placeholder="enter your email" value="<?php echo $email ?>">
                                        </div>
                                        <button name="sub-btn" type="submit" class="btn btn-primary">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
