                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <div class="profile-dis scrollable">
                                <a class="dropdown-item">
                                        <i class="ti-money m-r-5 m-l-5"></i> Balance : <span class="badge badge-pill badge-warning"> ₹' . $data['wallet_balance'] . '</span></a>
                    ';
                                    }
                                        ?>
                                        ...
                                        <a class="dropdown-item" href="../developer/wallet/">
        ...
        <div class="page-wrapper">
            ...
            if (mysqli_num_rows($res) > 0) {
                while ($mess = mysqli_fetch_array($res)) {
                    ...
                    Please Udpdate Your <a href="../view-profile-user/edit/" class="alert-link">Email</a>. To receive the notifications.
                  </div>';
                }
            }
                    ...
                    <div class=" col-6 ">
                        <div class="card">
                            <div class="card text-white bg-primary">
                                <br><br>
                                <div class="card-body">
                                    <h3 class="card-title">Software Marketplace</h3>
                                    <p style="font-size:20px;" class="card-text">Click here to check out<u> exciting softwares. </u></p>
                                    <a href="../showcase/" class="btn btn-dark">Software Marketplace</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card text-white bg-success">
                                ...
                                <h2 class="card-title">Purchase History</h2>
                                    <p style="font-size:20px;" class="card-text">Check out your <u>purchase history</u> here </p>
                                    <a href="./my-purchases/" class="btn btn-dark">Purchase History</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                            <div class="card text-white bg-warning">
                                ...
                                <div class="card-body">
                                    ...
                                    <p style="font-size:20px;" class="card-text">Click Here to Add Funds to the <u>Softown wallet</u> </p>
                                    <a href="./add-funds/" class="btn btn-dark">Add Funds</a>
                                </div>
                            </div>
                        </div>
                    </div>
