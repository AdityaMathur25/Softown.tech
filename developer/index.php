        ...
        <div class="page-wrapper">
            ...
            if (mysqli_num_rows($res) > 0) {
                while ($mess = mysqli_fetch_array($res)) {
                    ...
                    Please Udpdate Your <a href="../view-profile/edit/" class="alert-link">Email</a>. To receive the notifications.
                  </div>';
                }
            }
                    ...
                    <div class=" col-6 ">
                        <div class="card">
                            <div class="card text-white bg-primary">
                                <br><br>
                                <div class="card-body">
                                    <h2 class="card-title">Add Software</h2>
                                    <p style="font-size:20px;" class="card-text">List <u> Your Software</u>  here and earn for your hardwork</p>
                                    <a href="./add-product/" class="btn btn-dark">Add software</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card text-white bg-success">
                                ...
                                <h2 class="card-title">Add Funds</h2>
                                    <p style="font-size:20px;" class="card-text">Generate Receipts and <u>Add funds to your wallet</u>  </p>
        ...
        <div class="col-6">
                    <div class="card">
                            <div class="card text-white bg-warning">
                                <br><br>
                                <div class="card-body">
                                    <h2 class="card-title">Upgradge Plan</h2>
                                    <p style="font-size:20px;" class="card-text">Upgrade <u>Your plan</u> to unlock great benefits </p>
                                    <a href="./upgrade-plan/" class="btn btn-dark">Upgrade</a>
                                </div>
                            </div>
                        </div>
                    </div>
