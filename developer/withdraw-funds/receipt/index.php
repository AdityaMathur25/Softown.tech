...
if (isset($_POST["submit"])) {
    ...
    class PDF extends FPDF
    {
        ...
        { 
            ...
            $sql = "INSERT INTO `Withdraw_balance` (`id`, `Withdraw_id`, `username`, `amount`, `method`, `status`) VALUES (NULL, '$o_id', '$un', '$amount', '$mode', 'pending')";
