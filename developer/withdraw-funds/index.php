                                ...
                                <form method="post" action="./receipt/" target="_blank" class="form p-t-20">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            while ($data = mysqli_fetch_array($records)) {
                                            ?>
                                                <input type="number" min="1" max="<?php echo $data['wallet_balance'];  ?>" name="amount" class="form-control" placeholder="Amount" aria-label="amount" aria-describedby="basic-addon11" required>
                ...
                <div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">✳️ After Generating receipt you will get a unique Withdrawal-id and a Withdrawal Slip.</h6>
                            <h6 class="card-subtitle">✳️ You need to submit the Withdrawal Slip to the<b> <a href="https://wa.me/918104537999/?text=Hi">Whatsapp</a></b>.</h6>
                            <h6 class="card-subtitle">✳️ Then you will be connected to an Softown agent. </h6>
                            <h6 class="card-subtitle">✳️ Then After confirming your details your money will be send to your preffered payment mode.</h6>
                        </div>
                    </div>
                </div>
