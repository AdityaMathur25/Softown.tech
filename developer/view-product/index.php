            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Software</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div>
                    <div style="text-align: center;">
                        <a href="../add-product/" ><button type="button" class="btn btn-block btn-lg btn-info">Add Software</button></a>
                    </div>
                    <br>
...
<h1 style="text-align:center;">Software Information</h1>
  <thead>
    <tr>
      <th>Software Name</th>
      <th>Price</th>
      ...
      <tr class="active-row" align="center">
        ...
        <form action="../edit-product/" method="post">
          <td>
            ...
            <input class="nor btn-primary" type="submit" value="Edit">
          </td>
        </form>
        <!-- <td>
        ...
        <form action="../delete-product/" method="post">
          <td>
            ...
            <input class="nor btn-primary" type="submit" value="Delete">
          </td>
        </form>
