        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    $records = mysqli_query($con, $sql); // fetch data from database
                    while ($data = mysqli_fetch_array($records)) {
                        if ($data['acc_status'] == 'free') {
                            include('../upgrade-plan/plans/free.php'); 
                        }
                        elseif ($data['acc_status'] == 'gold') {
                            include('../upgrade-plan/plans/gold.php'); 
                        }
                        elseif ($data['acc_status'] == 'platinum') {
                            include('../upgrade-plan/plans/platinum.php'); 
                        }
